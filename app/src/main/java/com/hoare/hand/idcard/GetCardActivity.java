...
public class GetCardActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        if (manager == null) {
            manager = new IDCardManager(GetCardActivity.this);
        }
        startFlag = true;
...
//			    	String id = bundle.getString("id");//身份证号码
                    ...
                    if (NetWorkUtils.isNetworkConnected(GetCardActivity.this) && isconnect) {
                        String updata = Utils.getIdcard(GetCardActivity.this, idcard_id);
                        PushManager.getInstance(GetCardActivity.this).sendMessage(updata);
                    } else {
                        Toast.makeText(GetCardActivity.this, "与服务器断开连接", Toast.LENGTH_SHORT).show();
                    }
...
//----------------------------------------------------------验票
    ...
    PutSubscriber putSubscriber = new PutSubscriber() {
        ...
        public void onEvent(PutEvent putEvent) {
            ...
            Log.d("dddd", "putEvent sgs: " + sgs + ",renshu:" + renshu + ",id_n:" + idcard_id + ",xiangmu:" + Utils.getXiangmu(GetCardActivity.this));
            if ("01".equals(sgs)) {
                showDialogd("成人票", idcard_id, Utils.getXiangmu(GetCardActivity.this), String.valueOf(renshu));
                PlayVedio.getInstance().play(GetCardActivity.this, 5);
            } else if ("02".equals(sgs)) {
                PlayVedio.getInstance().play(GetCardActivity.this, 2);
                showDialogd("儿童票", idcard_id, Utils.getXiangmu(GetCardActivity.this), String.valueOf(renshu));
            } else if ("03".equals(sgs)) {
                PlayVedio.getInstance().play(GetCardActivity.this, 7);
                showDialogd("优惠票", idcard_id, Utils.getXiangmu(GetCardActivity.this), String.valueOf(renshu));
            } else if ("04".equals(sgs)) {
                PlayVedio.getInstance().play(GetCardActivity.this, 7);
                showDialogd("招待票", idcard_id, Utils.getXiangmu(GetCardActivity.this), String.valueOf(renshu));
            } else if ("05".equals(sgs)) {
                PlayVedio.getInstance().play(GetCardActivity.this, 3);
                showDialogd("老年票", idcard_id, Utils.getXiangmu(GetCardActivity.this), String.valueOf(renshu));
            } else if ("06".equals(sgs)) {
                PlayVedio.getInstance().play(GetCardActivity.this, 8);
                showDialogd("团队票", idcard_id, Utils.getXiangmu(GetCardActivity.this), String.valueOf(renshu));
            } else if ("07".equals(sgs)) {
                PlayVedio.getInstance().play(GetCardActivity.this, 6);
                showDialogMsg("已使用");
            } else if ("08".equals(sgs)) {
                PlayVedio.getInstance().play(GetCardActivity.this, 1);
                showDialogMsg("无效票");
            } else if ("09".equals(sgs)) {
                PlayVedio.getInstance().play(GetCardActivity.this, 9);
                showDialogMsg("已过期");
                ...
                showDialogd("年卡", idcard_id, Utils.getXiangmu(GetCardActivity.this), String.valueOf(renshu));
...
//            }
    ...
    ConnentSubscriber connectEventSubscriber = new ConnentSubscriber() {
        ...
        public void onEvent(ConnectEvent event) {
            BaseConfig bg = new BaseConfig(GetCardActivity.this);
        ...
        new CommomDialog(this, R.style.dialog, names, num, code, renshu, new CommomDialog.OnCloseListener() {
            ...
            public void onClick(Dialog dialog, boolean confirm) {
                if (confirm) {
                    ...
                    data.setType(1);
                    data.setpNum(renshu);
                    data.setName(Utils.getXiangmu(GetCardActivity.this));
